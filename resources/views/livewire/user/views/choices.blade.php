    ...
    <div class="container-xxl py-5" style="margin-top:-140px;">
        <div class="container py-5 px-lg-5">
            <div class="text-center pb-4 wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="text-primary-gradient fw-medium">Categories</h5>
                <h1 class="mb-5" style="color:#fff">What exactly you want to increase?</h1>
            </div>
            <div class="row gy-5 gx-4 justify-content-center">
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <h4 class="mt-4 mb-3" style="color:#000;"><a href="#" style="color:#000;">Likes</a></h3>
                            <p class="mb-0 details">Increase Liskes on your posts up to 1000!</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <h4 class="mt-4 mb-3" style="color:#000;"><a href="#" style="color:#000;">Followers</a>
                        </h4>
                        <p class="mb-0 details">Increase Followers on your posts up to 1000!</p>
                ...
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <h4 class="mt-4 mb-3" style="color:#000;"><a href="#" style="color:#000;">Views</a></h4>
                        <p class="mb-0 details">Increase Views on your posts up to 1000!</p>
                    </div>
                </div>
            </div>
        </div>
